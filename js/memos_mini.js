...
`;let container=document.getElementById("recent-posts");container.innerHTML=html+container.innerHTML;load_memos();function whenDOMReady(){initMemos()}whenDOMReady();document.addEventListener("pjax:complete",whenDOMReady);setTimeout(function(){initMemos();console.log("memos_mini.js loaded")},1500);function initMemos(){if(document.querySelector("#memos-mini")){let e=new Swiper(".swiper",{direction:"vertical",loop:true,autoplay:{delay:3e3,pauseOnMouseEnter:true},enable:true})}}